...
SKILL_KEYWORDS = {
    ...
    # 后端
    "node.js", "express", "django", "flask", "fastapi", "spring", "springboot", "spring boot",
    "laravel", "rails", "gin", "echo", "fiber",
    # 数据库
    "mysql", "postgresql", "mongodb", "redis", "elasticsearch", "oracle", "sqlserver",
    "sqlite", "cassandra", "neo4j", "dynamodb", "tidb", "oceanbase", "hbase", "clickhouse",
    # 云和DevOps
    ...
    "推荐系统", "推荐算法", "目标检测", "图像分割", "人脸识别",
    # 大数据
    "hadoop", "spark", "flink", "kafka", "hive", "presto", "airflow",
    "数据仓库", "etl", "数据治理", "数据湖", "数据平台",
    # 移动开发
    ...
    "redis", "memcached", "zookeeper", "etcd",
    # 工具
    "git", "svn", "cvs", "linux", "unix",
    "tcpdump", "wireshark", "抓包",
    # 协议
    "grpc", "restful", "graphql", "rpc",
    # 其他
    "数据结构", "算法", "设计模式",
    "项目管理", "敏捷开发", "scrum",
    "产品设计", "数据分析", "用户研究",
...
# 全局实例
skill_extractor = type('SkillExtractor', (), {
